...
public:
    ...
    bool IsUsingFixedWidth() const { return m_bFixedWidth; }
    bool IsUsingFixedHeight() const { return m_bFixedHeight; }
    ...
    bool DrawImage(HDC hDC, TDrawInfo& drawInfo, bool bExtDest);
