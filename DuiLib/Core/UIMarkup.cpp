...
CMarkupNode::CMarkupNode(CMarkup* pOwner, ULONG_PTR iPos) : m_pOwner(pOwner), m_iPos(iPos), m_nAttributes(0)
{
}
...
bool CMarkup::LoadFileOnlyForParse(LPCTSTR pstrFilename, int encoding)
{
    Release();
