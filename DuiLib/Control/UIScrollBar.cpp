...
void CScrollBarUI::SetButton1NormalImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton1Normal, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetButton1HotImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton1Hot, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetButton1PushedImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton1Pushed, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetButton1DisabledImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton1Disabled, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetButton2NormalImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton2Normal, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetButton2HotImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton2Hot, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetButton2PushedImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton2Pushed, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetButton2DisabledImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diButton2Disabled, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetThumbNormalImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diThumbNormal, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetThumbHotImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diThumbHot, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetThumbPushedImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diThumbPushed, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetThumbDisabledImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diThumbDisabled, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetRailNormalImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diRailNormal, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetRailHotImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diRailHot, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetRailPushedImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diRailPushed, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetRailDisabledImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diRailDisabled, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetBkNormalImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diBkNormal, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetBkHotImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diBkHot, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetBkPushedImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diBkPushed, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetBkDisabledImage(LPCTSTR pStrImage)
{
    ...
    ParseDrawInfo(m_pManager, m_diBkDisabled, m_nScale);
	Invalidate();
}
...
void CScrollBarUI::SetPos(RECT rc, bool bNeedInvalidate)
{
    ...
    SIZE cxyFixed = GetScaleSize(m_cxyFixed, m_nScale);
	rc = m_rcItem;
...
void CScrollBarUI::PaintRail(HDC hDC)
{
	...
	if( !m_bHorizontal ) {
		rc.left = m_rcThumb.left - m_rcItem.left;
		rc.top = (m_rcThumb.top + m_rcThumb.bottom) / 2 - m_rcItem.top - cxyFixed.cx / 2;
		rc.right = m_rcThumb.right - m_rcItem.left;
		rc.bottom = (m_rcThumb.top + m_rcThumb.bottom) / 2 - m_rcItem.top + cxyFixed.cx - cxyFixed.cx / 2;
	}
	else {
		rc.left = (m_rcThumb.left + m_rcThumb.right) / 2 - m_rcItem.left - cxyFixed.cy / 2;
		rc.top = m_rcThumb.top - m_rcItem.top;
		rc.right = (m_rcThumb.left + m_rcThumb.right) / 2 - m_rcItem.left + cxyFixed.cy - cxyFixed.cy / 2;
		rc.bottom = m_rcThumb.bottom - m_rcItem.top;
	}
