#ifndef __UIEXPAND_OPTION_H__
#define __UIEXPAND_OPTION_H__

#include "UIAnimation.h"

namespace DuiLib
{
	class DUILIB_API CExpandOptionUI : public COptionUI, public CUIAnimation
	{
		DECLARE_DUICONTROL(CExpandOptionUI)
	public:
		CExpandOptionUI();
		~CExpandOptionUI();
